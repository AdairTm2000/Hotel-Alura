	...
	public MenuUsuario() {
		...
		btnRegistro.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				RegistroHabitacion reservas = new RegistroHabitacion();
		...
		labelExit = new JLabel(new ImageIcon(ReservasView.class.getResource("/imagenes/cerrar-24px.png")));
		...
		btnCerrarSesion.setBounds(863, 550, 68, 35);
		btnCerrarSesion.setSize(70,50);
		btnCerrarSesion.setBorder(null);
		btnCerrarSesion.setBackground(Color.WHITE);
		
		labelsesion = new JLabel();
		labelsesion.setIcon(new ImageIcon(ReservasView.class.getResource("/imagenes/cerrar-sesion 32-px.png")));
		labelsesion.setBounds(10, 8, 53, 36);
		labelsesion.setForeground(SystemColor.black);
		btnCerrarSesion.add(labelsesion);
