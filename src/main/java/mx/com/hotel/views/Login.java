...
import mx.com.hotel.jdbc.controller.LoginController;
...
public class Login extends JFrame {
	...
	public Login() {
		...
		lblNewLabel_1.setBounds(195, 65, 100, 59);
	...
	private void Login() {
		...
		ArrayList<String> nLogin = new ArrayList<>();
		
		for (int i = 0; i < loginController.listar().size(); i++) {
			nLogin.add(this.loginController.listar().get(i).toString());
		}
			     	     	     
	    String nloginInterfaz = txtUsuario.getText() + contrase;
	    
	    if(nLogin.contains(nloginInterfaz)){
